...
class Wire:
    ...
    list_select_new_wireGroupID_xpath = "/html/body/div[1]/div[2]/main/div[3]/div/div[2]/div[2]/div[3]/div[3]/div/div/div[2]/select[1]/option[2]"
    list_select_new_color1_xpath = "/html/body/div[1]/div[2]/main/div[3]/div/div[2]/div[2]/div[3]/div[3]/div/div/div[2]/select[2]/option[2]"
    list_select_new_color2_xpath = "/html/body/div[1]/div[2]/main/div[3]/div/div[2]/div[2]/div[3]/div[3]/div/div/div[2]/select[3]/option[3]"
    list_select_new_color3_xpath = "/html/body/div[1]/div[2]/main/div[3]/div/div[2]/div[2]/div[3]/div[3]/div/div/div[2]/select[4]/option[1]"
    list_select_new_picktolight_xpath = "//*[@id='drdPickToLightId']"
    list_select_new_WLEDPinName_xpath = "//*[@id='txtNewWledPinName']"
    ...
    def SelectGroupIDFromList(self):
        time.sleep(2)
        self.driver.find_element("xpath", self.list_select_new_wireGroupID_xpath).click()
