...
class Dev:
    ...
    Printer_name_id = "txtPrinterName64"
    ...
    text_Systemgroup_xpath = "/html/body/div/div[2]/main/div[4]/div/div[2]/div/div/div[1]/span[1]/ul/li[1]/div/div[1]/h6/a"
    ...
    text_PPTtestpointCard_xpath = "/html/body/div/div[2]/main/div[4]/div/div[2]/div/div/div[1]/span[1]/ul/li[1]/div/div[2]/div/span/div/div[8]/div/ul/li/a[1]"
    ...
    btn_delete_PPTtestpointCard_xpath = "/html/body/div/div[2]/main/div[4]/div/div[2]/div/div/div[1]/span[1]/ul/li[1]/div/div[2]/div/span/div/div[8]/div/ul/li/a[2]/svg/path"
    btn_Confirmdelete_PPTtestpointCard_xpath = "/html/body/div[1]/div[2]/main/div[17]/div/div/div[2]/div[2]/button[2]"
    ...
    def setPPTTestPointCardPoints(self, pptcardpoints):
        self.driver.find_element(By.ID, self.PPT_Test_Point_id).clear()
        self.driver.find_element(By.ID, self.PPT_Test_Point_id).send_keys(pptcardpoints)
    ...
    def SysGrpClickDelete(self):
        self.driver.find_element("xpath", self.btn_delete_PPTtestpointCard_xpath).click()

    def SysGrpDelete(self):
        self.driver.find_element("xpath", self.btn_Confirmdelete_PPTtestpointCard_xpath).click()
