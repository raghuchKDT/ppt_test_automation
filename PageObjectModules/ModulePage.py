...
class Module:
    ...
    def ClickChooseFile(self):
        self.driver.find_element(By.XPATH, self.btn_new_Choosefile_module_xpath).send_keys("C:\\Users\\KnoDTec - Dheeraj\\Downloads\\Xcode_Module.jpg")
    ...
    def ClickEditChooseFile(self):
        time.sleep(2)
        self.driver.find_element(By.XPATH, self.btn_edit_Choosefile_module_xpath).send_keys("C:\\Users\\KnoDTec - Dheeraj\\Downloads\\Xcode_Module.jpg")
