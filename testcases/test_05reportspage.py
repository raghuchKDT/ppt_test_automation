...
from PageObjects.ReportsPage import reports
...
class Test_005_reports:
    ...
    def test_level2menubar(self, user_manager):
        ...
        # Validation of Report in Level2 Menu Bar
        # exp_ele1 = ['Report']
        # data_bas_ele1 = self.driver.find_elements(By.XPATH, "//*[@id='pills-report']/div/div/div[1]/div[1]/h6")
        #
        # for idx, bas_ele1 in enumerate(data_bas_ele1):
        #     print(idx, bas_ele1.text)
        #     assert (exp_ele1[idx] == bas_ele1.text)

        assert 'Report Mask' in self.driver.page_source

        # Validation of Report in Level2 Menu Bar
        # exp_ele2 = ['Report Mask']
        # data_bas_ele2 = self.driver.find_elements(By.XPATH, "//*[@id='pills-report']/div/div/div[2]/h6")
        #
        # for idx, bas_ele2 in enumerate(data_bas_ele2):
        #     print(idx, bas_ele2.text)
        #     assert (exp_ele2[idx] == bas_ele2.text)

        assert 'Global Variable' in self.driver.page_source
        # Validation of Report in Level2 Menu Bar
        # exp_ele3 = ['Global Variable']
        # data_bas_ele3 = self.driver.find_elements(By.XPATH, "//*[@id='pills-report']/div/div/div[3]/h6")
        #
        # for idx, bas_ele3 in enumerate(data_bas_ele3):
        #     print(idx, bas_ele3.text)
        #     assert (exp_ele3[idx] == bas_ele3.text)
